...
public class StudentController {
	...
	public List<Student> getStudent(@PathVariable("studentId") Long studentId) {
		...
		logger.info("In StudentController.getStudent({})", studentId);
	...
	public List<Student> registerNewStudent(@RequestBody Student student) {
		List<Student> list = new ArrayList<>(1);
		logger.info("In StudentController.registerNewStudent({})", student);
	...
	public void deleteStudent(@PathVariable("studentId") Long studentId) {
		logger.info("In StudentController.deleteStudent({})", studentId);
	...
	public void updateStudent(@PathVariable("studentId") Long studentId, @RequestParam(required = false) String name,
		...
		logger.info("In StudentController.updateStudent({}, {}, {}, {})", studentId, name, email, dateOfBirth);
		studentService.updateStudent(studentId, name, email, dateOfBirth);
	}
